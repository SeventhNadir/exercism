...
//    are independent from the original mtx.  That is, you should be able
//    to do as you please with the results without affecting the mtx.
//
// 2. You must implement a method Set(row, col, val) for setting a mtx
//    element.
//
